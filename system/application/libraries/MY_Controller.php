...
class MY_Controller extends Controller {
    ...
    protected function load_defaults() {
        ...
        //load the menus
        $this->data['main_menu']   = new Page(); 
        $this->data['main_menu']->get_menu('main');
        $this->data['bottom_menu'] = new Page();
        $this->data['bottom_menu']->get_menu('bottom');
    }
    ...
    protected function get_menu($type) {
    	$page = new Page();
    	$page->get_menu($type);
    }
